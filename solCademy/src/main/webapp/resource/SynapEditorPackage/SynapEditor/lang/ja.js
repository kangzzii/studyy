(function () {
    var messages = {
        ...
        "message.accessibility.fileSelector": "ファイルセレクター",
        "message.accessibility.ime": "入力メソッドエディタ",
        "message.accessibility.object": "オブジェクト",
        "message.accessibility.previewArea": "プレビュー領域",
        "message.accessibility.printArea": "印刷領域",
        ...
        "message.alert.beforeOpenLayout": "レイアウトを適用すると、書いている内容が消えます。 <br>  続けますか？",
        "message.alert.beforeOpenTemplate": "テンプレートを適用すると、作成中の内容が消えます。<br>続行しますか？",
        "message.alert.cannotInsertFileInTheArea": "エリアにファイルを挿入できません。",
        "message.alert.cannotUseImport": "インポート機能を使用することができません。",
        "message.alert.connectedLinesDisconnected": "図形が文字として扱われるようになり、接続されていたすべての接続線が解除されました。",
        "message.alert.duplicatedId": "重複したID。",
        "message.alert.enterBookmarkId": "ブックマークIDを入力してください。",
        ...
        "message.alert.invalidBookmarkId": "ブックマーク名に使用できない特殊文字が入っています。",
        "message.alert.invalidId": "IDに使用できない特殊文字が含まれています。",
        ...
        "message.alert.removeScript": "許可されていない <script> タグを削除します。",
        ...
        "message.error.base64MaxSize": "大きな画像ファイルは挿入できません。",
        ...
        "message.error.slideOutOfRangeError": "範囲外です。<br>最後のスライド番号は #{slideNum} です。",
        "message.error.slideWrongRangeError": "範囲が無効です。<br>正しい形式で入力してください。<br>ex) 1-3、5、7-10",
        "message.error.uploadFailedError": "アップロードに失敗しました。",
        "message.label.DivProperties": "レイヤープロパティ",
        "message.label.GroupProperties": "グループ属性",
        ...
        "message.label.colorPicker": "カラーピッカー",
        ...
        "message.label.customList": "カスタマイズされたリスト",
        ...
        "message.label.deleteGroup": "グループの削除",
        ...
        "message.label.groupDrawingObject": "グループ",
        ...
        "message.label.leftIndentation": "左インデント",
        ...
        "message.label.primaryColor": "基本色",
        ...
        "message.label.rightIndentation": "右インデント",
        ...
        "message.label.selectFile": "ファイル選択",
        ...
        "message.template.fixedWidth": "幅固定",
        ...
        "message.template.numberFormat": "数値フォーマット",
        ...
        "message.template.pastePreviewMessage1": "Synap Editor でコピーしたコンテンツをプレビューします。",
        "message.template.pastePreviewMessage2": "外部からコピーした内容は見えません。",
        "message.template.pasteTabDefalut": "プレビュー",
        "message.template.pasteTabPaste": "貼り付け",
        "message.template.poster": "Poster",
        "message.template.prev": "前",
        "message.template.preview": "プレビュー",
        "message.template.product": "製品名",
        ...
        "message.template.slide": "スライド番号",
        "message.template.slide.cnt": "スライドの総数は #{slideCnt} です。",
